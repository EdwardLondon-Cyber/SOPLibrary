...
NOTE: The build_req_table.py file is a new addition (as of October 2021)! Don't forget to grab this file as well and add it to your directory when working on a Standard!
