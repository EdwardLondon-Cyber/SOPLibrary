...
[source]
----
asciidoctor <name of doc>.adoc -r asciidoctor-rouge -a allow-data-uri -a source-highlighter=rouge -o <name of doc>.html
----
...
[source]
----
asciidoctor-pdf <name of doc>.adoc -r ./document_basecamp/scripts/asciidoctor-pdf-extensions.rb -o <name of doc>.pdf
----
