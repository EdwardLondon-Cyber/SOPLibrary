...
=== Add Document Basecamp with Git Submodule 
...
Cloning or fetching the document_basecamp from a previous commit is done in the root of the document. Before you run these commands you should see a .gitmodule file (hidden) and a document_basecamp directory that is empty.
