...
//## E
//|EAR|The Export Administration Regulations (EAR) are regulations set forth in parts 730-774, inclusive, of Title 15 of the Code of Federal Regulations. The EAR are issued by the United States Department of Commerce, Bureau of Industry and Security (BIS) under laws relating to the control of certain exports, reexports, and activities. The term “dual use” is often used to describe the types of items subject to the EAR. A “dual-use” item is one that has civil applications as well as terrorism and military or weapons of mass destruction (WMD)-related applications. However, the precise description of what is “subject to the EAR” is defined in § 734.3, which does not limit the EAR to controlling only dual-use items. (15 CFR §§730-774)
...
//|IT Project| According to link:https://cset.nasa.gov/latest/npr-7120.7[NPR 7120.7__x__], an IT project is a specific investment having defined requirements, a life-cycle cost, a beginning, and an end. An IT project has a management structure and is planned, executed, and controlled according to a formal methodology and governed through a defined series of life-cycle reviews. An IT project may have interfaces to other projects, programs, agencies, and international partners. An IT project yields a new or revised system/service that directly addresses NASA's strategic goals.
//|ITAR| The International Traffic in Arms Regulations (ITAR) are regulations set forth in parts 120 - 130, inclusive, of Title 22 of the Code of Federal Regulations. The ITAR governs the manufacture, export, and temporary import of defense articles; the furnishing of defense services; and brokering activities involving items described on the United States Munitions List (USML). (22 CFR §§120 - 130) The Department of State is responsible for the export and temporary import of defense articles and services governed by 22 U.S.C. 2778 of the Arms Export Control Act (AECA) and Executive Order 13637. The International Traffic in Arms Regulations ("ITAR," 22 CFR 120-130) implements the AECA. (U.S. Department of State)
...
//|Level of Assurance| Level of Assurance (LOA) is the amount of certainty that individuals accessing a physical or logical asset are who they claim to be. NIST SP 800-63 provides guidance for determining LOA. (NPR 2841.1)
//|Level of Confidence| Level of Confidence (LOC) is the amount of certainty, based on identity proofing and investigation, that an individual can be trusted with access to NASA physical and IT assets. (NPR 2841.1)
//|Level of Risk| Level of Risk (LOR) is the amount of vulnerability to NASA, based on the likelihood and consequences of an adverse action through improper access or use of a physical or IT asset. (NPR 2841.1)
...
//|PIV Credential|PIV stands for a "Personal Identity Verification". A PIV credential is a U.S. federal government-wide credential used to access federally controlled facilities and information systems at the appropriate security level. 
