...
This Technical Specification  is approved for use by NASA Headquarters and all NASA Centers. It is intended to describe technical requirements for purchased or in-house items, services, functions, or processes for NASA programs and projects. It provides the enforceable, measurable details of a technical standard.

Adherence to this Specification ensures compliance with (fill in sentence and reference NASA or other Federal policy, standard, or specification subject matter — this may be specific to formal documents, or simply general subject matter).

Requests for information, corrections, or additions to this Specification should be directed to the John H. Glenn Research Center at Lewis Field (GRC), Cybersecurity Standards and Engineering Team (CSET) , MS 142-5, Cleveland, OH, 44135 or to nasa-ascs-staff@lists.nasa.gov.
...
The documents listed in this section support requirements of this NASA Technical Specification, as cited in the text. Use of other guidance in system implementations shall be documented by the ISO and approved by an AO.
...
== DOCUMENT BODY WHICH STARTS AT SECTION 5
