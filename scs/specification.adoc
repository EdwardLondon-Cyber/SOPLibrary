...
// applicability: if this spec is applicable to all computing systems, enter "all". if this spec is only applicable to systems using this OS or application, leave value blank
:applicability: all
