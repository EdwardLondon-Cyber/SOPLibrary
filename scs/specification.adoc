...
NOTE: 
 ...
 If you are writing an updated version of a Standard, the approval date must be hard coded for the earlier version(s), and the variable for approval date must be used only for the most recent version.
