...
Adherence to this Specification ensures compliance with NASA-STD-2601, which defines operating system and application security requirements that must be implemented on NASA information systems.
