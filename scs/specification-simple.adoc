...
releveantstandard: Relevant standard
...
////
// Table content
:function:  Incident Monitoring and Response
:application:  FireEye HX
:relevantstandard:  Example standard
:requiredsettings:  Auto-updates enabled
:minversion: 26.x
...
The purpose of this NASA Technical Standard is to provide {application} Security Configuration Specification guidance.
...
|link:https://developer.nasa.gov/ETADS/NASA-STD-2601securityconfigurations[NASA-STD-2601]|_Security Requirements for Computing Devices_
