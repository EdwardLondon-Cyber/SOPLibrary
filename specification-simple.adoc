...
|link:https://developer.nasa.gov/ETADS/NASA-STD-2601securityconfigurations[NASA-SPEC-2601]|_Security Requirements for Computing Devices_
...
[%header,width="100%",cols="2,1,2,2,1,3,2"]
|====
|Function
|Application
|Relevant Standards
