...
=== Purpose
//  You may need to rewrite the Purpose section so that it is accurate for your spec. 
...
// You may need to edit this section, depending on the nature of your Specification.
...
The AO *_SHALL_* ensure that only systems posing an acceptable level of risk (LOR) to Agency assets, data, and personnel are approved for production operation and that all necessary documentation is produced and maintained.
...
APPLICABLE DOCUMENTS
  ...
  Use YOURLS to link the Document Identifier.
////
...
Add sections and subsections as necessary for the content of your Spec. 
////
