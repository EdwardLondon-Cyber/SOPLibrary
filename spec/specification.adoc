...
_Required_ settings *_MAY_*, in limited and justified instances, be amended through the proper application of an RBD. To pursue an RBD, see <<Tailoring>> in this Specification.
