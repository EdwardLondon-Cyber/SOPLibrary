...
// AUTONUMBERING: Special variables for auto numnber requirements
// The reqkey should be the document number (such as 2601) the counter will auto-increment the requirements
//   so the result will be the reqkey, a "-R", then the requirement number (such as 2601-R8). 
:reqkey: 
