...
// (260X R) = the requirement statement acronym. It consists of the number from the document identifier (e.g., 2601), followed by a space, and then the letter R (for requirement) and a number. 

// *EXAMPLE: (2601 R1) = appears in front of the first *_SHALL_* statement within NASA-STD-2601 

Verifiable requirement statements are numbered and designated by the acronym (260**X** R#); verifiable requirement statements contain the word "*_SHALL_*". This NASA Technical Standard contains *#* requirements. To facilitate requirements selection by NASA programs and projects, a Requirements Compliance Matrix is provided in Appendix A.  
...
These documents can serve as additional support in meeting the requirements of this NASA Technical Standard.
...
// Enter all requirements into this matrix. 
// Only enter information for the first 3 columns (|Section |Description |Requirement) - see the example below. 
// leave the Applicable and Comments columns blank - this is what program managers, project managers, and cybersecurity SERT members will use (like a worksheet). 

[width="100%",cols="1,3,3,1,2"]
|====
|Section |Description |Requirement |Applicable | Comments
...
////
*EXAMPLE* Requirements Compliance Matrix
  This example was taken from Standards 2602
...
| 4.1
| Agency-approved encryption solutions for data storage devices
| *(2602 R1)* ISOs, system administrators, and users *_SHALL_* adhere to the requirements pertaining to Agency-approved encryption solutions on Agency-approved data storage devices defined in ASCS Specifications in the NASA-SPEC-2601__x__ and NASA-SPEC-2602__x__ series.
| 
|

| 4.1
| Agency-approved encryption solutions for mobile devices
| *(2602 R2)* Only mobile devices and operating systems that include Federal Information Processing Standards (FIPS) 140-validated cryptographic modules approved by the National Institute of Standards and Technology (NIST) SHALL be deployed.
| 
|
