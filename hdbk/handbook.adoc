...
DOCUMENT VARIABLES (that are not on cover page) DESCRIPTIONS:
  ...
  relevanttechnicalstandard:   Name of the relevant Technical Standard (i.e., NASA-STD-2601, Section 5.7.; NPR 2810.1; NIST SP 800-53 R5)
////
